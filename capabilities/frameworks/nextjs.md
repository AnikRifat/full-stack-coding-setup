...
Choose server and client boundaries according to real interaction and data requirements. Keep privileged data and operations server-side, with validation and authorization at the actual entry points. Apply [coding rules](../../rules/coding.md) and [simplicity](../../rules/simplicity.md).
