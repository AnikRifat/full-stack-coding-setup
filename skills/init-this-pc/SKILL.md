...
Use this skill for a direct request to prepare this computer's Codex or Claude working environment, or to make a clean scratch workspace for experiments. It is separate from [init-this-project](../init-this-project/SKILL.md), which initializes an actual software project.
