...
Use this skill only for a requested computer-level agent environment or an isolated scratch workspace. Route application scaffolding, repository instructions, framework choice, and implementation to [project-init](../../project-init/SKILL.md) or the lifecycle loop.
