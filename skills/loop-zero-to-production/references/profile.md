...
- Use connected micro-skills, with architecture, coding, debugging, review, and the former Lazyagent approach merged into [Labour](../../labour/SKILL.md). Preserve context through [the shared handoff](handoff.md).
...
- Include accurately attributed [Karpathy-inspired principles](../../labour/references/engineering-principles.md) and [strict coding rules](../../labour/references/coding-rules.md). Their concrete implementation is the library's starting policy, not a claim that previously unknown personal conventions were recovered.
