...
Return the framing to the [product method](product-method.md) for scope decisions or [plan-do](../../plan-do/SKILL.md) for goal-driven execution planning. Actual release readiness still depends on agreed criteria, not classification alone.
