...
Check the changed skill's frontmatter, metadata, and local reference links. For routing or decision changes, use relevant cases from [evaluation.md](evaluation.md). State the type of validation actually performed.
