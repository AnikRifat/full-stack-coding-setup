...
Report findings by severity with precise file context, verification evidence, and remaining uncertainty. Route supported repairs to [code-implement](../code-implement/SKILL.md) or [debug-investigate](../debug-investigate/SKILL.md).
