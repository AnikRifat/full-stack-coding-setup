...
Feed the plan into [project-init](../project-init/SKILL.md), [arch-design](../arch-design/SKILL.md), or [code-implement](../code-implement/SKILL.md) according to project state. Under [loop-delivery](../loop-delivery/SKILL.md), planning is an intermediate outcome and the authorized loop continues. A planning-only request finishes at the reviewable plan.
