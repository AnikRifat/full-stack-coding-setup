...
Anik expects a recommendation with relevant trade-offs. A short decision can be enough for a narrow feature; a larger engagement benefits from a brief that can feed [delivery-plan](../../delivery-plan/SKILL.md). Use [domains.md](domains.md) when business or integration constraints change the choice.
