...
Establish the observed behavior, expected behavior, reproduction, affected environment, and previous attempts. Read [debugging guidance](references/debug.md), [coding rules](../../rules/coding.md), [output rules](../../rules/output.md), [databases](../../capabilities/databases.md) when the failure involves data or query behavior, and context-matched capabilities.
