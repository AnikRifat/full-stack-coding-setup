...
Explain the cause, why the change addresses it, verification performed, and any residual uncertainty. Capture a reusable debugging lesson only when asked, using [personalize.md](../../loop-zero-to-production/references/personalize.md); do not make an environment-specific repair a universal rule.
