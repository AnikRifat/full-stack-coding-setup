...
Inspect the real code, logs, and data path before answering. Route a reproducible failure through [bug-investigate](../bug-investigate/SKILL.md), an agreed change through [code-implement](../code-implement/SKILL.md), a flow or wording problem through [flow-design](../flow-design/SKILL.md), and a visual or component defect through [ui-audit](../ui-audit/SKILL.md). Verify the repair with [behavior-verify](../behavior-verify/SKILL.md) before reporting it resolved. Apply [coding rules](../../rules/coding.md), [output rules](../../rules/output.md) to any repair; payment, authorization, and personal-data paths keep their guarantees under support pressure too.
