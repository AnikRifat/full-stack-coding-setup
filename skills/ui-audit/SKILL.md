---
name: ui-audit
description: Audit an interface's visual clarity, consistency, accessibility, and implementation quality. Use for UI presentation and component concerns; keep user journeys and product flows within flow-design.
---

# Audit the interface

Inspect the actual screens, component system, responsive states, and relevant visual requirements. Evaluate hierarchy, spacing, typography, color contrast, states, consistency, responsiveness, and accessible interaction presentation.
