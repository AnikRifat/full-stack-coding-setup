...
Inspect the repository, project context, requirements, and existing conventions before proposing a boundary or pattern. Read [architecture guidance](references/architecture.md), [core rules](../../rules/coding.md), and only the capability guidance that matches the actual stack.
...
Return a reviewable design or focused change plan. Route implementation to [code-implement](../code-implement/SKILL.md), planning to [plan-do](../plan-do/SKILL.md), and product ambiguity to the lifecycle coordinator's product method.
