...
Inspect the repository, project context, requirements, and existing conventions before proposing a boundary or pattern. Read [architecture guidance](references/architecture.md), [core rules](../../rules/coding.md), [output rules](../../rules/output.md), and only the capability guidance that matches the actual stack. For a schema, migration, query, or data-modeling decision read [databases](../../capabilities/databases.md).
