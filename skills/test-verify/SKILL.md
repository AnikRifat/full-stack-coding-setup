...
Report executed commands, outcomes, unverified paths, and any blocked dependency. Route a demonstrated failure to [debug-investigate](../debug-investigate/SKILL.md); use the lifecycle handover method only for an overall deploy-ready outcome.
